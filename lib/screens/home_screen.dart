              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder<List<MoodEntry>>(
                    future: moodService.getEntriesByDateRange(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final todayEntries = snapshot.data ?? [];
                      
                      if (todayEntries.isEmpty) {
                        return const Text('Вы еще не записали настроение сегодня');
                      }
                ...
                children: [
                  ...
                  FutureBuilder<double>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Text(
                        'Средний уровень настроения: ${avgMood.toStringAsFixed(1)}',
                      );
                    },
                  ),
                  FutureBuilder<MoodType?>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Text(
                        'Наиболее частое настроение: ${mood.emoji} ${mood.label}',
                      );
                    },
                  ),
                ],
